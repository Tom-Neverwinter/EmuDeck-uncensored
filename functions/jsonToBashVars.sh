...
function jsonToBashVars(){
    ...
    setSetting doInstallEden "$(jq '.installEmus.eden.status // false' "$json")"
    ...
    setSetting doSetupEden "$(jq '.overwriteConfigEmus.eden.status // .installEmus.eden.status // false' "$json")"
    ...
    setSetting edenResolution  "$(jq '.resolutions.eden // .resolutions.yuzu' "$json")"
